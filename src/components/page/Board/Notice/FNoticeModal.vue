        ...
        <div class="backdrop">
            <div class="container">
                ...
                <div class="button-box">
                    ...
                    <button v-if="props.idx" @click="hadlerDeleteBtn">삭제</button>
...
const searchDetail = () => {
    axios.post("/api/board/noticeDetailBody.do", { noticeSeq: props.idx }).then((res) => {
        ...
        noticeDetail.value.context = res.data.detail.content;
        if (["jpg", "gif", "png"].includes(noticeDetail.value.fileExt)) {
            getFileImage();
        }
    });
};
